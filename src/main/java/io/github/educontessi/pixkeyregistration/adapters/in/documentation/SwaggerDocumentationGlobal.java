...
@Documented
@ApiResponses(value = {@ApiResponse(responseCode = "422", description = "Invalid requisition", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ResponseError.class))),
